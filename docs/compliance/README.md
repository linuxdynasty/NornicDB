...
- Background workers and MVCC for auditors: [background-workers-mvcc-audit-guide.md](background-workers-mvcc-audit-guide.md)
...
- Background processing and version history: [background-workers-mvcc-audit-guide.md](background-workers-mvcc-audit-guide.md)
