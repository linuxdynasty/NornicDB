...
func TestLoadFromEnv_EncryptionProvider(t *testing.T) {
	...
	t.Setenv("NORNICDB_ENCRYPTION_MASTER_KEY", "0123456789abcdef0123456789abcdef")
	...
	require.Equal(t, "0123456789abcdef0123456789abcdef", cfg.Database.EncryptionMasterKey)
